  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            <span className="text-red-700">
              Error Image Upload. Please Try again....
            </span>
          ) : filePer > 0 && filePer < 100 ? (
            <span className="text-orange-700">{`Uploading ${filePer}%`}</span>
          ) : filePer === 100 ? (
        ...
        <Link
          className="text-white uppercase bg-green-700 p-3 rounded-lg text-center hover:opacity-95"
          to="/create-listing"
        >
          Create Listing
        </Link>
